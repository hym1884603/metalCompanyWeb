...
$.fn.showTooltips = function()
{
	...
	return this.each(function()
	{
		...
		this.tooltip = $("<span class='fv_tooltip' style='display:block'></span>").append(s).append(b).css({"filter":"alpha(opacity:95)","KHTMLOpacity":"http://www.dg-pf.com/include/Scripts/validation/0.95","MozOpacity":"http://www.dg-pf.com/include/Scripts/validation/0.95","opacity":"http://www.dg-pf.com/include/Scripts/validation/0.95"});
		//注册事件
